...
###############################################################################
### See bug on the latest version of roxygen 6.0.1 : https://github.com/klutometis/roxygen/issues/595
### A previous version of roxygen2 were installed!
###devtools::install_version(package = 'roxygen2',version = '5.0.1', repos = c(CRAN = "https://cran.rstudio.com"))
### If an arror related to 'roxygen2-dev-test' error occur, intastall the versione ofd "roxygen2" written above.
library(roxygen2)
library(devtools)
...
if (toCran) { 
			...
			system(paste("rm -rf",cran_pkg_unuseful,sep=" "))
			cran_pkg_unuseful <- paste(cran_pkg_dir,"README.md",sep="/")
			system(paste("rm -rf",cran_pkg_unuseful,sep=" "))
			cran_pkg_unuseful <- paste(cran_pkg_dir,"NEWS.md",sep="/")
			system(paste("rm -rf",cran_pkg_unuseful,sep=" "))
			
			toremove <- c(".R*",".DS_Store","inst/.DS_Store","inst/doc/.DS_Store","inst/doc/examples/.DS_Store","inst/doc/examples/snowstuff/.DS_Store","inst/template/.DS_Store","inst/template/friuli/.DS_Store", ".Rapp.history")
